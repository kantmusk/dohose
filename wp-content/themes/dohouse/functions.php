...
function enqueue_parent_styles() {
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/libs/jquery/jquery.min.js', array(), '20130110', true );    

  
    wp_enqueue_script( 'slickjs', get_template_directory_uri() . '/libs/slick/slick.min.js', array(), '20130110', true );    

   
    wp_enqueue_script( 'maskedinput', get_template_directory_uri() . '/js/jquery.maskedinput.min.js', array(), '20130112', true );
    
   

    wp_enqueue_script( 'scripts', get_template_directory_uri() . '/js/common.js', array(), '20130118', true );

    //wp_enqueue_script( 'yandexmap', get_template_directory_uri() . '/js/yandexmap.js', array(), '20130115', true );
...
{
   wp_register_style('bootstrap', get_template_directory_uri() . '/libs/bootstrap/bootstrap-grid.min.css');
        wp_enqueue_style('bootstrap'); 

        wp_register_style('slickcss', get_template_directory_uri() . '/libs/slick/slick.css');
...
register_post_type('project', // Register Custom Post Type
    array(
    'labels' => array(
        'name' => __('Проекты', 'project'), // Rename these to suit
        'singular_name' => __('Проекты', 'project'),
        'add_new' => __('Добавить', 'project'),
        'add_new_item' => __('Добавить', 'project'),
        'edit' => __('Редактировать', 'project'),
        'edit_item' => __('Редактировать', 'project'),
        'new_item' => __('Новый', 'project'),
        'view' => __('Показать', 'project'),
        'view_item' => __('Показать', 'project'),
        'search_items' => __('Найти', 'project'),
        'not_found' => __('Не найден', 'project'),
        'not_found_in_trash' => __('Не найден', 'project')
    ),
    'public' => true,
...
//require get_template_directory() . '/carbon.php';
